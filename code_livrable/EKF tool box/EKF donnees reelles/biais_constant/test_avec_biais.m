...
% Initialisation des matrice de pondération
ekf.ProcessNoise = diag([1e-2,1e-2,1,10,0.5, 1e-6,1e-6]); % Matrice Q
ekf.MeasurementNoise = diag([0.05, 0.05, 0.5]); % Matrice R
...
% Initial EKF state
ekf.State = [xm(1); ym(1); u(1); v0; psi0; bu0; bv0]; % Initial state estimate
